...
from wheat.entity.config_entity import DataIngestionConfig, DataTransformationConfig,DataValidationConfig,   \
...
class Configuartion:
    ...
    def get_data_ingestion_config(self) ->DataIngestionConfig:
        ...
        Raises:
            WheatException: If any exception occurs Custom exception is raised
