...
from wheat.entity.artifact_entity import DataTransformationArtifact, ModelTrainerArtifact
from wheat.entity.config_entity import ModelTrainerConfig
from wheat.util.util import load_numpy_array_data,save_object,load_object
from wheat.entity.model_factory import MetricInfoArtifact, ModelFactory,GridSearchedBestModel
from wheat.entity.model_factory import evaluate_classification_model



class WheatEstimatorModel:
...
class ModelTrainer:
    ...
    def initiate_model_trainer(self)->ModelTrainerArtifact:
        try:
            ...
            wheat_segregation_model = WheatEstimatorModel(preprocessing_object=preprocessing_obj,trained_model_object=model_object)
            logging.info(f"Saving model at path: {trained_model_file_path}")
            save_object(file_path=trained_model_file_path,obj=wheat_segregation_model)
